...
public class RuntimeInit {
     ...
     */
//    可以看到在注释l 处通过反射获得了android.app.Acti vityThrea d 类，接下来在注释2
//    处获得了ActivityThread 的main 方法，并将main 方陆传入注释3 处的Zygote 中的
//    MethodAndArgsCaller 类的构造方怯中。在注释3 处抛出的MethodAndArgsCaller 异常会
//    被Zygote 的main 方怯捕获，至于这里为何采用了抛出异常而不是直接调用ActivityThread
//    的main 方法，原理和本书2.3.1 节Zygote 处理SystemServer 进程是一样的，这种抛出异
//    常的处理会清除所有的设置过程需要的堆枝帧，并让ActivityThread 的main方法看起来
//    像是应用程序进程的人口方法
...
//    在applicationlnit 方法中会在注释l 处调用invokeStaticMain方法， 需要注意的是， 第
//    一个参数args . startClass ，它指的就是本章开头提到的参数android.app.ActivityThread
