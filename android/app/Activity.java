...
public class Activity extends ContextThemeWrapper
     ...
     * @see #startActivity
     */
//    注释l 处的mParent 是Activity 类型的，表示当前Activity 的父类。因为目前根Activity
//    还没有创建出来， 因此， mParent == null 成立。接着调用Instrumentation 的execStartActivity
//    方法， Instrumentation 主要用来监控应用程序和系统的交互。
    public void startActivityForResult(@RequiresPermission Intent intent, int requestCode,
